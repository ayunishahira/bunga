    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                ...
                <input type="text" name="flat" placeholder="e.g. house no." required>
            </div>
            <div class="inputBox">
			...
			<div class="inputBox">
                <span>postcode :</span>
                <input type="text" name="pin_code" placeholder="e.g. 12345" required>
            </div>
            <div class="inputBox">
                <span>city :</span>
                <input type="text" name="city" placeholder="e.g. Ipoh" required>
            </div>
            <div class="inputBox">
				<span>state :</span>
